<x-student-layout>
    <div class="max-w-5xl mx-auto pb-24">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
            <a href="{{ route('student.results') }}" class="flex items-center text-slate-400 hover:text-blue-600 font-black text-[10px] uppercase tracking-widest transition-all italic-none">
                <i class="fas fa-arrow-left mr-2"></i> Back to Result Gateway
            </a>
        ...
        <div class="bg-white rounded-[3.5rem] border-2 border-slate-100 shadow-2xl overflow-hidden print:border-0 print:shadow-none italic-none">
            ...
            <div class="p-12 border-b-8 border-blue-600 flex flex-col md:flex-row items-center justify-between gap-8 bg-slate-50/50">
                ...
                <div class="text-center md:text-right space-y-2">
                    <h3 class="text-2xl font-black text-blue-600 uppercase italic-none tracking-tight">Report Card</h3>
            ...
            <div class="px-12 py-10 bg-white border-b border-slate-100 grid grid-cols-1 md:grid-cols-4 gap-8 italic-none">
                ...
                <div class="space-y-1">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest italic-none">Class Group</p>
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-sm font-black text-emerald-600 uppercase italic-none">Card Authenticated</p>
                </div>
            </div>
            ...
            <div class="p-12 bg-slate-900 text-white flex flex-col md:flex-row items-center justify-between gap-8 italic-none">
                <div class="flex items-center bg-white/5 border border-white/10 px-8 py-5 rounded-3xl shadow-xl">
                    ...
                    <div>
                        <p class="text-[10px] font-black text-blue-300 uppercase tracking-widest italic-none">Electronic Authentication</p>
                ...
                <div class="text-center md:text-right">
                    <p class="text-[9px] font-bold text-slate-500 uppercase tracking-[0.2em] italic-none">Digital Transcript Registry</p>
                    <p class="text-[10px] font-black text-slate-400 uppercase mt-2 italic-none">Generated on: {{ now()->format('d/m/Y • H:i') }}</p>
                </div>
            </div>
        </div>
    </div>
